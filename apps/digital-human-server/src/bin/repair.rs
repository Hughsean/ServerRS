...
use digital_human_server::app::web_ingestion::services::vector_activation_service;
use digital_human_server::bootstrap::infra::InfraContext;
use digital_human_server::bootstrap::repos::build_repos;
use digital_human_server::bootstrap::vector::VectorContext;
use digital_human_server::domain::rag::RAGRepoT;
use digital_human_server::domain::web_ingestion::repo::{
    IngestionRunRepoT, PublishRecordRepoT, VectorManifestRepoT,
};
use digital_human_server::infra::web_ingestion::repo::{
    IngestionRunRepo, PublishRecordRepo, VectorManifestRepo,
};
use digital_human_server::shared::config::AppConfig;
