...
fn review_list_uses_joined_partial_model_instead_of_manual_hydration() {
    let review = source("../../crates/digital-human/src/infra/web_ingestion/review_repository.rs");
...
fn indexable_chunks_load_parent_documents_without_n_plus_one_queries() {
    let rag = source("../../crates/digital-human/src/infra/repo/seaorm_impl/rag.rs");
    let start = rag
...
fn list_queries_use_partial_models_to_exclude_large_or_sensitive_columns() {
    let user = source("../../crates/digital-human/src/infra/repo/seaorm_impl/user.rs");
    let music = source("../../crates/digital-human/src/infra/repo/seaorm_impl/music.rs");
    let psychology = source("../../crates/digital-human/src/infra/repo/seaorm_impl/psychology.rs");
