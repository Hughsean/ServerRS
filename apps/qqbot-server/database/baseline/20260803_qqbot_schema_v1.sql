-- QQBot / 个人 QQ 智能秘书 Schema Baseline v1
...
CREATE TABLE IF NOT EXISTS `secretary_thread_decisions` (
  ...
  KEY `idx_secretary_thread_decision_thread` (`thread_id`,`status`,`created_at`),
...
CREATE TABLE IF NOT EXISTS `secretary_thread_link_candidates` (
  ...
  CONSTRAINT `chk_secretary_thread_link_candidate_kind` CHECK ((`signal_kind` in (_utf8mb4'explicit_project_id',_utf8mb4'exact_file_source_key'))),
...
CREATE TABLE IF NOT EXISTS `secretary_thread_link_hints` (
  ...
  CONSTRAINT `chk_secretary_thread_link_hint_kind` CHECK ((`signal_kind` in (_utf8mb4'explicit_project_id',_utf8mb4'exact_file_source_key')))
...
CREATE TABLE IF NOT EXISTS `secretary_thread_owner_controls` (
  ...
  CONSTRAINT `chk_secretary_thread_control_kind` CHECK ((`control_kind` in (_utf8mb4'confirm_decision',_utf8mb4'revoke_decision',_utf8mb4'dismiss_question',_utf8mb4'close_thread',_utf8mb4'reopen_thread'))),
  CONSTRAINT `chk_secretary_thread_control_target` CHECK ((`target_kind` in (_utf8mb4'decision',_utf8mb4'question',_utf8mb4'thread')))
