...
#[cfg(feature = "qq_bot")]
async fn init_qq_bot_integration(ctx: &BootstrapContext<'_>, background: &mut BackgroundTasks) {
...
async fn init_qq_bot_integration(_ctx: &BootstrapContext<'_>, _background: &mut BackgroundTasks) {}
