...
pub struct PlatformUserId(pub u64);

/// Port owned by QQ Bot for resolving a platform account without depending on
/// the digital-human user repository.
#[async_trait]
pub trait PlatformUserDirectory: Send + Sync {
